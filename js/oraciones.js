/* ============================================================
   LSPedia - Construye la oración V4 integrada
   93 actividades de español cotidiano (Perú)
   ============================================================ */
const OracionesV2 = (function(){
  ...
  function crearLogica(){
    ...
    function renderMenu(){
      ...
      const tips={
        1:"15 situaciones: casa, colegio, trabajo, salud, compras y transporte.",
        2:"15 verbos: mira de dónde nace la conjugación y cómo cambia con el tiempo.",
        3:"15 situaciones para aprender y, pero, porque, entonces, por eso y cuando.",
        4:"15 ejercicios de escritura: verbos, artículos, preposiciones y palabras útiles.",
        5:"18 conversaciones reales: familia, colegio, trabajo, salud, mercado, bus, banco y más.",
        6:"15 oraciones más completas con tiempo, conectores, causas y detalles."
      };
