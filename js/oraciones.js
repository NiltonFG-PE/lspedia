/* ============================================================
   LSPedia - Construye la oración V7 integrada
   250 actividades de español cotidiano (Perú) · 50 por nivel
   ============================================================ */
const OracionesV2 = (function(){
  ...
  function crearLogica(){
    ...
    function renderMenu(){
      ...
      const tips={
        ...
        5:"50 oraciones más completas con tiempo, conectores, causas y detalles."
      };
    ...
    function renderOrder(){
      ...
      const extra=state.level===5
        ...
        : '';
      a.innerHTML=extra+'<div class="builder"><div class="slots"></div><div class="bank"></div><div class="help">'+(state.level===5?'Forma una oración más completa. Mira colores y orden.':'Toca/arrastra las palabras a su lugar.')+'</div></div>';
    ...
    function checkOrderIfFull(){
      if((state.level!==1&&state.level!==5)||state.locked)return;
      const slots=[...shadow.querySelectorAll(".slot")];
  ...
  function restaurarDesdeUrl(){
    ...
    mostrarSoloOraciones();
    if(p.get("pantalla")==="partida") juego.iniciarPartidaDesdeHistorial(Math.min(5,Number(p.get("nivel")||1)));
