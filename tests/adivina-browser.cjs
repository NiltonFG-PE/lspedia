...
(async()=>{
 ...
 try{
  ...
  await page.locator('#correct').click();await page.clock.runFor(900);assert.equal(await page.locator('#score').innerText(),'✓ 1');
  ...
  await sensor(90);await page.clock.runFor(350);await sensor(90);await sensor(140);await page.clock.runFor(200);await sensor(140);await page.clock.runFor(900);
  assert.equal(await page.locator('#score').innerText(),'✓ 1');
  await sensor(140);await page.clock.runFor(500);await sensor(140);assert.equal(await page.locator('#score').innerText(),'✓ 1');
